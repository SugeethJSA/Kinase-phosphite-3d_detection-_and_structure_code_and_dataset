...
train_motifs = np.genfromtxt(r'C:\Users\Tim\EMBER\data\train_motifs.csv', dtype='U')
train_motifxFamMatrix = np.genfromtxt(r'C:\Users\Tim\EMBER\data\train_motifxFamMatrix.csv', delimiter=',', dtype=int)
test_motifs = np.genfromtxt(r'C:\Users\Tim\EMBER\data\new_test_motifs.csv', dtype='U')
test_motifxFamMatrix = np.genfromtxt(r'C:\Users\Tim\EMBER\data\new_test_motifxFamMatrix.csv', delimiter=',', dtype=int)
fams = np.genfromtxt(r'C:\Users\Tim\EMBER\data\fams.csv', dtype='U')
...
embedding = np.genfromtxt(r"C:\Users\Tim\EMBER\MODELS_siam\embedding.csv",delimiter=',',dtype=float)
...
all_fams = (np.genfromtxt(r"C:\Users\Tim\EMBER\data\fam_distances_blos62\fams.csv",dtype='U'))
dist_matrix = (np.genfromtxt(r"C:\Users\Tim\EMBER\data\fam_distances_blos62\dist_matrix.csv",delimiter=',',dtype=float))
